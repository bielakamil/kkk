...
<head>
    <title> MojePrawko.pl - wyeksportuj ucznia do PDF  </title>
    <?php head (); ?>
</head>
        ...
        <header class="all" id="head">
            ...
            <div id="text">
                ...
                <?php
                    ...
                    if ($status == 1) {
                        echo $admin->export_to_pdf_user();
                    } elseif ($status == 2) {
                        echo $instruktor->export_to_pdf_user();
                    } elseif ($status == 3) {
                        echo $uczen->export_to_pdf_user();
                    }
            ...
            if ($status == 1) {
                echo $admin->export_to_pdf_user_kafel();
            } elseif ($status == 2) {
                echo $instruktor->export_to_pdf_user_kafel();
            } elseif ($status == 3) {
                echo $uczen->export_to_pdf_user_kafel();
            }
            ?>
