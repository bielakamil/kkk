...
<head>
    <title> MojePrawko.pl - wszystkie kategorie wykładów </title>
    <?php head (); ?>
</head>
...
<div id="search-input"> 
          ...
          <h1 class="add"> Wszystkie kategorie </h1>

       
        <?php
        if ($_SESSION['status'] == 1)
        {
            echo '<a href="../page/add-kategoria.php">';
        ...
        <div id="text" class="all-page show">
                <?php
                    ...
                    if ($status == 1) {
                        $admin->PokazWszystkieKategorieWykladow();
                    } elseif ($status == 2) {
                        $instruktor->PokazWszystkieTematyWykladow();
                    } 
