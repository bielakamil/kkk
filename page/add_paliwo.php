...
<html>
<head>
    <title> MojePrawko.pl - dodaj paliwo </title>
    <?php head () ?>
</head>
        ...
        <header class="all" id="head">
            ...
            <div id="text">
                ...
                <?php
                    ...
                    if ($status == 1) {
                        echo $admin->add_paliwo($_GET['id']);
                    } elseif ($status == 2) {
                        echo $instruktor->add_paliwo($_GET['id']);
                    }
            ...
            if ($status == 1) {
                echo $admin->add_paliwo_kafel();
            } elseif ($status == 2) {
                echo $instruktor->add_paliwo_kafel();
            }
            ?>
