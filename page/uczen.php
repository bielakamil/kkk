...
?>
<title> MojePrawko.pl - uczeń </title>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 bottom">
                            ...
                            switch ($status)
                            {
                                case 1:
                                    {
                                        echo $admin->show_profil_uczen($id);
                                        break;
                                    }
                                case 2: 
                                    {
                                        echo $instruktor->show_profil_uczen($id);
                                        break;
                                    }
                                case 3:
                                    {
                                        if (isset($_GET['id']))
                                        {
                                            $uczen->show_profil_uczen_inny($_GET['id']);
                                        } else
                                        {
                                            $uczen->show_profil_uczen();
                                        }
                                        break;
                                    }
                                default:
