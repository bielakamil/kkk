...
?>
<title> MojePrawko.pl - jazdy </title>
                ...
                <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12 head" id="head">
                    ...
                    <div class="row">
                        ...
                        if ($status == 1) {
                            ...
                            if (isset($_GET['uczen']))
                            {
                                $admin->PokazJazdyUcznia($_GET['uczen']);
                            } elseif (isset($_GET['instruktor']))
                            {
                                $admin->PokazWszystkieJazdyInstruktora($_GET['instruktor']);
                            } elseif (isset($_GET['new']))
                            {
                                $admin->PokazWszystkieNajblizszeJazdy();
                            } else
                            {
                                $admin->PokazWszystkieJazdy();
                            }
                            ...
                            if (isset($_GET['uczen']))
                            {
                                $instruktor->PokazJazdyUcznia($_GET['uczen']);
                            } elseif (isset($_GET['new']))
                            {
                                $instruktor->PokazWszystkieNajblizszeJazdy();
                            } elseif (isset($_GET['all']))
                            {
                                $instruktor->PokazWszystkieJazdyWSzkole();
                            } else
                            {
                                $instruktor->PokazWszystkieJazdy();  
                            }
                        ...
                        }  elseif ($status == 3)
                        {
                            if (isset($_GET['new']))
                            {
                                $uczen->PokazWszystkieNajblizszeJazdy();
                            } elseif (isset($_GET['all']))
                            {
                                $uczen->PokazWszystkieJazdyUcznia();
                            } else 
                            {
                                $uczen->PokazWszystkieJazdy();
                            }
                        }
                    ?>
                        </div>
