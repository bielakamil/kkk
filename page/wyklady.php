...
?>
<?php head (); ?>
<title> MojePrawko.pl -  wszystkie wykłady</title>
                ...
                <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12 head" id="head">
                    ...
                    <div class="row">
                        ...
                        if ($status == 1) {
                            ...
                            if (isset($_GET['new']))
                            {
                                $admin->PokazWszystkieNajblizszeWyklady();
                            } elseif (isset($_GET['uczen']))
                            {
                                $admin->PokazWszystkieWykladyUcznia($_GET['uczen']);
                            } elseif (isset($_GET['instruktor']))
                            {
                                $admin->PokazWszystkieWykladyInstruktora($_GET['instruktor']);
                            } else
                            {
                                $admin->PokazWszystkieWyklady();
                            }
                            ...
                            if (isset($_GET['new']))
                            {
                                $instruktor->PokazWszystkieNajblizszeWyklady();
                            } elseif (isset($_GET['instruktor']))
                            {
                                $instruktor->PokazWszystkieWykladyInstruktora($_GET['instruktor']);
                            } elseif (isset($_GET['uczen']))
                            {
                                $instruktor->PokazWszystkieWykladyUcznia($_GET['uczen']);
                            } else
                            {
                                $instruktor->PokazWszystkieWyklady();
                            }
                        ...
                        }  else
                        {
                            ...
                            if (isset($_GET['new']))
                            {
                                $uczen->PokazWszystkieNajblizszeWyklady();
                            } else
                            {
                                $uczen->PokazWszystkieWyklady();
                            }
