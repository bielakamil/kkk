...
<head>
    <title> MojePrawko.pl - edytuj instruktora </title>
    <?php head (); ?>
</head>
       ...
       <div id="top">            <i class="material-icons" onclick="show_menu()"> menu </i>
        ...
        <div id="text">
            ...
            switch ($status)
            {
                case 1:
                    {
                        echo $admin->edit_profil_instruktor($id);
                        break;
                    }
                case 2: 
                    {
                        echo $instruktor->edit_profil_instruktor();
                        break;
                    }
                case 3:
                    {
            ...
            if ($status == 1) {
                echo $admin->edit_profil_instruktor_kafel();
            } elseif ($status == 2) {
                echo $instruktor->edit_profil_instruktor_kafel();
            }
            ?>
