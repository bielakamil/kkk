...
<html>
<head>
    <title> MojePrawko.pl - dodaj/usuń pieniądze </title>
    <?php head (); ?>
</head>
        ...
        <header class="all" id="head">
            ...
            <div id="text">
                ...
                <?php
                        ...
                        if ($status == 1) {
                            echo $admin->add_instruktor_pieniadze($_GET['id']);
                        }  
            ...
            <?php
                        ...
                        if ($status == 1) {
                            echo $admin->add_instruktor_pieniadze_kafel();
                        }     
