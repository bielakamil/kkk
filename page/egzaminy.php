                ...
                <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12 head" id="head">
                    ...
                    <div class="row">
                        ...
                        if ($status == 1) {
                            ...
                            if (isset($_GET['uczen']))
                            {
                                $admin->PokazWszystkieEgzaminyUcznia($_GET['uczen']);
                            } elseif (isset($_GET['instruktor']))
                            {
                                $admin->PokazWszystkieEgzaminyInstruktora($_GET['instruktor']);
                            } elseif (isset($_GET['new']))
                            {
                                $admin->PokazWszystkieNajblizszeEgzaminy();
                            } else
                            {
                                $admin->PokazWszystkieEgzaminy();
                            }
                            ...
                            if (isset($_GET['uczen']))
                            {
                                $instruktor->PokazWszystkieEgzaminyUcznia($_GET['uczen']);
                            } elseif (isset($_GET['new']))
                            {
                                $instruktor->PokazWszystkieNajblizszeEgzaminy();
                            } else
                            {
                                $instruktor->PokazWszystkieEgzaminy();  
                            }
                            
                        }  elseif ($status == 3)
                        {
                            $uczen->PokazWszystkieEgzaminy();
                        }
                    ?>
                        </div>
                    </div>
