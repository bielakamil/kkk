...
<html>
<head>
    <title> MojePrawko.pl - samochód </title>
    <?php head (); ?>
</head>
...
<?php include_once("../script/analyticstracking.php") ?>
    ...
    <header class="all" id="head">
        ...
        <div id="text">
                    ...
                    if ($status == 1) {
                        echo $admin->add_przebieg($_GET['id']);
                    } elseif ($status == 2) {
                        echo $instruktor->add_przebieg($_GET['id']);
                    } 
            ...
            if ($status == 1) {
                echo $admin->add_przebieg_kafel();
            } elseif ($status == 2) {
                echo $instruktor->add_przebieg_kafel();
            }
            ?>
