...
<head>
    <title> MojePrawko.pl - administrator </title>
    <?php head (); ?>
</head>
    ...
    <header class="all" id="head">
        ...
        <div id="text">
            ...
            switch ($status)
            {
                case 1:
                    {
                        echo $admin->show_profil_admin($id);
                        break;
                    }
                case 2: 
                    {
                        echo $instruktor->show_profil_admin($id);
                        break;
                    }
                default:
                    {
            ...
            if ($status == 1) {
                echo $admin->show_profil_admin_kafel();
            } elseif ($status == 2) {
                echo $instruktor->show_profil_admin_kafel($id);
            } 
            ?>
